...
function FormLayout(props) {
  ...
  const onSubmit = (formValues) => {
    ...
    data.patient = findOne(patients, { id: formValues.patient });
    data.treatment = findOne(treatments, { id: formValues.treatment });
  ...
  const [startStr, setStartStr] = React.useState(props.data.startStr);
  ...
  const [endStr, setEndStr] = React.useState(props.data.endStr);
